...
public:
  ...
  GetConfig(mediapipe::SubgraphContext *sc) override {
    ...
    auto& scale_image_options = scale_image_node.GetOptions<mediapipe::ScaleImageCalculatorOptions>();
    ...
    graph.SideIn("OCR_MODEL_PATH").SetName("ocr_model_path").Cast<std::string>() >> ocr_node.SideIn("OCR_MODEL_PATH");
